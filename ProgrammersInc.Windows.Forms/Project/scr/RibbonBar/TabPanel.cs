...
{
    /// <summary>
    /// Panel al estilo Office 2007 personalido.
    /// </summary>
    public class TabPanel : System.Windows.Forms.Panel
    {
        /// <summary>
        /// Crea una nueva instancia de la clase <see cref="ProgrammersInc.Windows.Forms.TabPanel"/>.
        /// </summary>
        public TabPanel()
        {
            timer1.Interval = 1;
        ...
        /// <summary>
        /// Obtiene o establece el color base para el control.
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el color base del control al activarse.
        /// </summary>
        public Color BaseColorOn
        {
            get { return _BaseColorOn; }
            set
            {
                _BaseColorOn = value;
                R0 = _BaseColor.R;
        ...
        /// <summary>
        /// Obtiene o establece el titulo a mostrar en el control.
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el valor de la velocidad de la animacion del control.
        /// </summary>
        public int Speed
        {
            get { return i_factor; }
        ...
        /// <summary>
        /// Obtiene o establece el valor de la opacidad para el control.
        /// </summary>
        public int Opacity
        {
            get { return i_Op; }
        ...
        /// <summary>
        /// Provoce el evento <see cref="ProgrammersInc.Windows.Forms.TabPanel.OnPaint"/>.
        /// </summary>
        /// <param name="e">Una instancia <see cref="System.Windows.Forms.PaintEventArgs"/> que 
        /// contiene los datos del evento.</param>
        ...
        /// <summary>
        /// Provoca el evento <see cref="ProgrammersInc.Windows.Forms.TabPanel.OnMouseEnter"/>
        /// </summary>
        /// <param name="e">Una instancia <see cref="System.Windows.Forms.PaintEventArgs"/> que 
        /// contiene los datos del evento.</param>
        ...
        /// <summary>
        /// Provoca el evento <see cref="ProgrammersInc.Windows.Forms.TabPanel.OnMouseLeave"/>
        /// </summary>
        /// <param name="e">Una instancia <see cref="System.Windows.Forms.PaintEventArgs"/> que 
        /// contiene los datos del evento.</param>
        ...
        /// <summary>
        /// Asistente de dibujo 1 para dibujar arcos.
        /// </summary>
        public void DrawArc()
        {
        ...
        /// <summary>
        /// Asistente de dibujo 2 para dibujar arcos.
        /// </summary>
        ...
        /// <summary>
        /// Asistente de dibujo 3 para dibujar arcos.
        /// </summary>
        ...
        /// <summary>
        /// Provoca el evento <see cref="ProgrammersInc.Windows.Forms.TabPanel.OnResize"/>
        /// </summary>
        /// <param name="e">Una instancia <see cref="System.Windows.Forms.PaintEventArgs"/> que 
        /// contiene los datos del evento.</param>
