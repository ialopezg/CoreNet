 ...
 *
 * Description  : NavigateBar menu option form
 * 
 */
...
namespace ProgrammersInc.Windows.Forms
{
    partial class NavigateBarOptions : Form
    {
        ...
        void InitNavigateBarOptions()
        {
            ...
            btnCancel.Text = Resources.TEXT_BUTTON_CANCEL;
            btnMoveDown.Text = Resources.TEXT_BUTTON_MOVE_DOWN;
            btnMoveUp.Text = Resources.TEXT_BUTTON_MOVE_UP;
            btnReset.Text = Resources.TEXT_BUTTON_RESET;
            btnOK.Text = Resources.TEXT_BUTTON_OK;

            Text = Resources.TEXT_MENU_OPTIONS.Replace("&", "").Replace("...", "");
            lblOrderDescription.Text = Resources.TEXT_LABEL_ORDER_DESCRIPTION;
