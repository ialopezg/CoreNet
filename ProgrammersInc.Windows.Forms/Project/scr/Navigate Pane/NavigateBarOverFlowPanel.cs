...
namespace ProgrammersInc.Windows.Forms
{
    ...
    class NavigateBarOverFlowPanel : UserControl
    {
        ...
        void InitNavigateBarOverFlowPanel()
        {
            ...
            mnShowMoreButton.Text = Resources.TEXT_SHOW_MORE_BUTTONS;
            mnShowMoreButton.Image = Resources.ArrowUp;
            ...
            mnShowFewerButton.Text = Resources.TEXT_SHOW_FEWER_BUTTONS;
            mnShowFewerButton.Image = Resources.ArrowDown;
            ...
            mnMenuOptions.Text = Resources.TEXT_MENU_OPTIONS;
            ...
            mnAddRemoveButton.Text = Resources.TEXT_ADD_OR_REMOVE_BUTTON;
            ...
            panelArrowNavBtn = new NavigateBarButton(Resources.TEXT_CONFIGURE_BUTTONS);
            panelArrowNavBtn.NavigateBar = NavigateBar;
            panelArrowNavBtn.ToolTipText = Resources.TEXT_CONFIGURE_BUTTONS;
