...
namespace ProgrammersInc.Windows.Forms
{
    ...
    public class BaseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialize a new instance of the BaseRenderer class.
        /// </summary>
        public BaseRenderer()
        ...
        public BaseRenderer(ProfessionalColorTable professionalColorTable)
                ...
                using (UseAntiAlias useAntiAlias = new UseAntiAlias(graphics))
                {
                    if (e.ToolStrip is MenuStrip)
                    {
                        if ((item.Selected == true) && (item.Pressed == false))
                        {
                            ...
                            System.Windows.Forms.ControlPaint.DrawBorder(e.Graphics, bounds, colorTable.MenuItemTopLevelSelectedBorder, ButtonBorderStyle.Solid);
                        }
                        if (item.Pressed == true)
                        {
                            ...
                            System.Windows.Forms.ControlPaint.DrawBorder(e.Graphics, innerBorderRectangle, ColorTable.ButtonSelectedHighlightBorder, ButtonBorderStyle.Solid);
                            System.Windows.Forms.ControlPaint.DrawBorder(e.Graphics, bounds, ColorTable.MenuBorder, ButtonBorderStyle.Solid);
                        }
                    }
                    else
                    {
