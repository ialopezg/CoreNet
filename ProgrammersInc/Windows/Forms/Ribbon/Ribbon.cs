...
{
    /// <summary>
    /// Representa un control que provee la funcionalidad de fichas de contenido.
    /// </summary>
    [Description("Representa un control que provee la funcionalidad de fichas de contenido.")]
        ...
        : Control
    {
        ...
        /// <summary>
        /// Crea una nueva instancia del control <see cref="Ribbon"/>.
        /// </summary>
        public Ribbon()
        {
            ...
            this.colorTable = RibbonColorTable.Blue;
            _renderer = new RibbonProfessionalRenderer(this.colorTable);
        }
        ...
        #region Props
        RibbonColorTable colorTable;
        /// <summary>
        /// Obtiene o establece el color del control.
        /// </summary>
        [DefaultValue(RibbonColorTable.Blue)]
        [Description("Obtiene o establece el color del control.")]
        public RibbonColorTable ColorTable
        {
            ...
            set
            {
                ...
                _renderer = new RibbonProfessionalRenderer(colorTable);
        ...
        /// <summary>
        /// Suspends the paint functionallity until <see cref="ResumePaint"/> is called
        /// </summary>
        ...
        /// <summary>
        /// Resumes the paint functionallity suspended by <see cref="SuspendPaint"/>
        /// </summary>
