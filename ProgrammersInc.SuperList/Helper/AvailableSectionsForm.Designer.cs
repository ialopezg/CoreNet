...
namespace ProgrammersInc.SuperList.Helper
{
	partial class AvailableSectionsForm
	{
		...
		{
            ProgrammersInc.SuperList.Sections.SectionFactory sectionFactory1 = new ProgrammersInc.SuperList.Sections.SectionFactory();
			this._panel = new System.Windows.Forms.Panel();
            this._availableSectionsControl = new ProgrammersInc.SuperList.Helper.AvailableSectionsControl();
