...
using ProgrammersInc.SuperList.Helper;
using ProgrammersInc.Utility.Assemblies;
using ProgrammersInc.Utility.Collections;
...
namespace ProgrammersInc.SuperList.Sections
{
    ...
    public class ToolStripOptionsToolbarSection : OptionsToolbarSection
    {
        ...
        {
            ManifestResources res = new ManifestResources("ProgrammersInc.SuperList.Resources");
